...
def getUserInput():
    ...
    parser.add_option("-r", "--range", dest="range", help="IP range 192.168.6.0/24,/16,/8")
    parser.add_option("-R", "--retry" ,dest="retry", default=2, type="int", help="Retry count (default=2)")
    parser.add_option("-t", "--timeout", dest="timeout", default=3, type="int", help="Timeout in seconds (default=3)")
...
def main() -> None:
    ...
    print()
    print(f"Received {len(answered) + len(unanswered)} packets, "
